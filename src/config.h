...
/*
 * OPTION: Default TrueType font sizes (when using SDL2)
 */
#define DEFAULT_SDL2_TTF_FONT_SIZE              10
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_MAIN    DEFAULT_SDL2_TTF_FONT_SIZE
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_1       DEFAULT_SDL2_TTF_FONT_SIZE
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_2       DEFAULT_SDL2_TTF_FONT_SIZE
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_3       DEFAULT_SDL2_TTF_FONT_SIZE - 4
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_4       DEFAULT_SDL2_TTF_FONT_SIZE - 2
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_5       DEFAULT_SDL2_TTF_FONT_SIZE - 2
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_6       DEFAULT_SDL2_TTF_FONT_SIZE - 4
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_7       DEFAULT_SDL2_TTF_FONT_SIZE - 4
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_8       DEFAULT_SDL2_TTF_FONT_SIZE - 4
#define DEFAULT_SDL2_TTF_FONT_SIZE_TERM_9       DEFAULT_SDL2_TTF_FONT_SIZE - 4

/*
 * OPTION: Minimal and maximal allowed TrueType font size
 */
#define MIN_SDL2_TTF_FONT_SIZE 4
#define MAX_SDL2_TTF_FONT_SIZE 32
