...
int check_guide_checksums(bool forced) {
	...
	c_msg_format("Verifying Guide version against hash at %s, please wait (max %ds)...", TOMENET_GUIDE_SHA256_URL, TOMENET_GUIDE_SHA256_URL_TIMEOUT);
