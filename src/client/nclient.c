...
int Net_start(int sex, int race, int class) {
	...
	/* 4.7.4 and newer servers can communicate using 32bit character size redefinitions. */
	if (is_atleast(&server_version, 4, 7, 4, 0, 0, 0)) {
...
int Receive_char(void) {
	...
	/* 4.7.4 and newer servers communicate using 32bit character size. */
	if (is_atleast(&server_version, 4, 7, 4, 0, 0, 0)) {
