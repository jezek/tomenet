...
static errr Term_curs_sdl2(int x, int y) {
	//TODO jezek - Reuse tilePreparation for drawing cursor instead of creating new surface.
	SDL_Surface *cursor;
...
static SDL_Color sdl2_tileset_preview_mask_color(int type, int index, int count) {
	if (index < 0) index = 0;
	...
	SDL_Color color = {col, col, col, 255};
	switch (type) {
		case 0: return (SDL_Color){0, col, 0, 255};
		case 1: return (SDL_Color){0, 0, col, 255};
		case 2: return (SDL_Color){col, 0, 0, 255};
	}
...
static void term_data_init_graphics(term_data *td) {
	...
	//TODO jezek - Keep only the rawpict tiles in the tiles_surface?
