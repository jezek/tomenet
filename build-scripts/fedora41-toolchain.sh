...
# Minimal, readable toolchain setup for Fedora 41 distrobox
...
#
# Create new build container and install packages needed for building (run only once).
# $ distrobox create --name tomenet-fedora-41 --image registry.fedoraproject.org/fedora:41
# $ distrobox enter tomenet-fedora-41 -- bash ./build-scripts/fedora41-toolchain.sh
#
